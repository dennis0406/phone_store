          ...
          <div className="detail">
            ...
            <div className="detail-content">
              ...
              <div class="box_top_mb">
                <span class="conhang visible-xs ">Còn hàng </span>
              </div>
              <p class="top_prd ">
                <span class="_price">
                  <b>{product.price_image} VNĐ</b>
                </span>
              </p>
              <div class="accessories">
                ...
                <ul>
                  <li>
                    ...
                    Tặng bảo hành toàn diện 6 tháng&nbsp;
                    <a href="https://didongthongminh.vn/bao-hanh-dien-thoai-cu-toan-dien">
                      chi tiết
                    </a>
                  </li>
                  <li>
                    ...
                    Tặng que chọc sim từ thép không gỉ&nbsp;
                  </li>
                  <li>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    Tặng cable Veger C to Lighning trị giá 150,000vnđ chính
                    hãng&nbsp;
                  </li>
                  <li>
                    <svg
                    ...
                    Trợ giá sạc nhanh chính hãng Apple giảm 300,000 VNĐ còn
                    490,000 VNĐ
                  </li>
                </ul>
              </div>
              <div class="accessories">
                ...
                <ul>
                  <li>
                    ...
                    Bảo hành 6 tháng tại hệ thống Di Động Thông Minh -{" "}
                    <a href="https://didongthongminh.vn/bao-hanh-dien-thoai-cu-toan-dien">
                      chi tiết
                    </a>
                  </li>
                  <li>
                    ...
                    Bảo hành toàn diện&nbsp;cả nguồn, màn hình, vân tay&nbsp;
                  </li>
                  <li>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    1 đổi 1 trong 30 ngày nếu máy có lỗi từ nhà sản xuất
                  </li>
                </ul>
              </div>
              <button
